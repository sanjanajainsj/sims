...
class SeedsControllerTest < ActionController::TestCase
  ...
  test "should create seed" do
    assert_difference('Seed.count') do
      post :create, seed: { box: @seed.box, gid: @seed.gid, location: @seed.location, room: @seed.room, row: @seed.row, shelf: @seed.shelf, source: @seed.source, stock_id: @seed.stock_id }
    end
  ...
  test "should update seed" do
    patch :update, id: @seed, seed: { box: @seed.box, gid: @seed.gid, location: @seed.location, room: @seed.room, row: @seed.row, shelf: @seed.shelf, source: @seed.source, stock_id: @seed.stock_id }
    assert_redirected_to seed_path(assigns(:seed))
  end
